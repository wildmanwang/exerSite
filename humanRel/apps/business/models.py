...
class relEvent(models.Model):
    ...
    person = models.ForeignKey(verbose_name="事主", to="baseinfo.Person", related_name="eventPerson", on_delete=models.PROTECT)
    eventType = models.IntegerField(verbose_name="事件类型", choices=((1, "结婚"), (2, "生子"), (3, "周岁"), (4, "祝寿"), (5, "考学"), (6, "乔迁"), (7, "身故"), (0, "其他")))
    formType = models.IntegerField(verbose_name="宴请类型", choices=((1, "隆重宴请"), (2, "亲朋小聚"), (3, "低调跳过"), (0, "待定")))
...
class joinRecord(models.Model):
    ...
    recTime = models.TimeField(verbose_name="登记时间", null=True)
    remark = models.CharField(verbose_name="备注", max_length=255, null=True)
